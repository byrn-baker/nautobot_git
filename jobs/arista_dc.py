...
class CreateAristaPod(Job):
    ...
    def run(self, data=None, commit=None):
        ...
        ROLES = {
            "spine": {"device_type": "spine_veos", "interfaces": {"Ethernet1": "leaf", "Ethernet2": "leaf", "Ethernet3": "leaf", "Ethernet4": "leaf"}},
            "leaf": {"device_type": "leaf_veos", "interfaces": {"Ethernet1": "spine", "Ethernet2": "spine"}},
        }
